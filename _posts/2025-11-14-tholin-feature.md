...
{% include image.html file="/assets/images/news/tholin-feature/ic1.png" description="Tholin's custom silicon designs showcase what's possible with open tooling" %}
...
{% include image.html file="/assets/images/news/tholin-feature/as2650.png" description="The AS2650(-2) is inspired by retro CPUs like the Signetics 2650" %}
...
{% include image.html file="/assets/images/news/tholin-feature/logo_bw.png" description="Tholin's logo, adapted for silicon artwork" %}
...
{% include image.html file="/assets/images/news/tholin-feature/padout.png" description="Padout diagram generated from Python and LibreLane configuration" %}
...
{% include image.html file="/assets/images/news/tholin-feature/3d_view.png" description="Standard cells are a key component of RTL to GDSII flows" %}
